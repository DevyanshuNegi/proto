...
function Home() {
  ...
  return (
<div className="w-full mt-4 h-screen flex flex-col items-center justify-start pt-20 px-10 sm:px-14 bg-gradient-to-b from-[#0e1c33] to-[#1a2540] text-white">      <h1 className="text-5xl md:text-6xl font-extrabold text-center mb-6 text-gradient leading-tight">
